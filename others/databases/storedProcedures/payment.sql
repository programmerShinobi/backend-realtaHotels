...
DECLARE
    ...
    TransactionNumber text := payment.getTransactionNumber(TransactionID, TransactionType, TransactionDate);
	...
	NextTransactionNumber text := payment.getTransactionNumber(NextTransactionID, TransactionType, TransactionDate);
